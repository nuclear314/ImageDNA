...
import { GeneratedTag, classifyTag, generatePrompt, makeExcludeFilter, sortByPriority } from '../lib/promptGeneration';
...
const PromptGenerator: React.FC<PromptGeneratorProps> = ({ selectedModel }) => {
  ...
  useEffect(() => {
    ...
    setGeneratedTags(sortByPriority(without));
  }, [subjectType]);
  ...
  const handleGenerate = () => {
    if (!modelTags) return;
    setGeneratedTags(generatePrompt(modelTags, {
